...
public class BankLoginTest {
    ...
    @Test
    @DisplayName("Should get error notification if login with exist in base and active and random verification code")
    void shouldSetErrorNotificationIfLoginWithExistUserAndRandomVerificationCode() {
        var authInfo = DataHelper.getAuthInfoWithTestData();
        var verificationPage = loginPage.validLogin(authInfo);
        verificationPage.verifyVerificationPageVisibility();
